...
inputfile = "output" # Output file from CFOUR frequency calculation
natoms    = 4        # Number of atoms of the molecule
...
# save_displacements_xyz(outputfile, dimless_disp, ref_geom,atoms_array, min_displacement, max_displacement, step_displacement,ghost=True)
